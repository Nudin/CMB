...
%    bookmarks=true,
    ...
    pdffitwindow=false,
    pdfstartview={FitH},
    pdftitle={Der Kosmische Mikrowellenhintergrund und seine Anisotropien},
    pdfauthor={Michael F. Sch\"onitzer},
    pdfsubject={Der Kosmische Mikrowellenhintergrund},
    pdfkeywords={CMB} {Mikrowellenhintergrund} {Anisotropien} {Astrophysik},
    pdfnewwindow=true,
    colorlinks=true,
    linkcolor=black,
    citecolor=black,
